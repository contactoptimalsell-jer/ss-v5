...
L'équipe SkillShield AI`;
    ...
    try {
      ...
      attachments: [
        {
          filename: 'skillshield-logo.svg',
          content: `<?xml version="1.0" encoding="UTF-8"?>
<svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M10 20L25 35" stroke="#0891b2" stroke-width="2" stroke-linecap="round" opacity="0.4" />
  <path d="M90 20L75 35" stroke="#0891b2" stroke-width="2" stroke-linecap="round" opacity="0.4" />
  <path d="M50 95L50 80" stroke="#0891b2" stroke-width="2" stroke-linecap="round" opacity="0.4" />
  <circle cx="10" cy="20" r="2" fill="#06b6d4" opacity="0.4" />
  <circle cx="90" cy="20" r="2" fill="#06b6d4" opacity="0.4" />
  <path d="M50 92C25 78 15 35 15 15L50 5L85 15C85 35 75 78 50 92Z" stroke="#22d3ee" stroke-width="4" stroke-linecap="round" stroke-linejoin="round" />
  <path d="M48 30C40 30 32 35 32 50C32 65 40 70 48 70C49 70 48 60 48 50V30Z" stroke="#67e8f9" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round" />
  <path d="M52 30C60 30 68 35 68 50C68 65 60 70 52 70C51 70 52 60 52 50V30Z" stroke="#67e8f9" stroke-width="3.5" stroke-linecap="round" stroke-linejoin="round" />
  <path d="M38 42C35 42 35 48 38 48" stroke="#a5f3fc" stroke-width="2.5" stroke-linecap="round" />
  <path d="M40 58C36 58 38 62 42 62" stroke="#a5f3fc" stroke-width="2.5" stroke-linecap="round" />
  <path d="M62 42C65 42 65 48 62 48" stroke="#a5f3fc" stroke-width="2.5" stroke-linecap="round" />
  <path d="M60 58C64 58 62 62 58 62" stroke="#a5f3fc" stroke-width="2.5" stroke-linecap="round" />
</svg>`,
